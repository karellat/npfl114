...
class Network:
    def __init__(self, env, args):
        ...
        self.baseline.add(tf.keras.layers.Input(shape=(4,)))
        self.baseline.add(tf.keras.layers.Dense(args.hidden_layer, activation='relu'))
    ...
    def train(self, states, actions, returns):
        ...
        self.model.train_on_batch(states, actions, sample_weight=(returns - baseline.flatten()))
